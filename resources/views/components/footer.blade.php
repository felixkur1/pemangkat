...
<footer class="bg-slate-800 mt-8">
  <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div class="grid grid-cols-2 gap-12 sm:gap-8 sm:grid-cols-3 md:w-1/2">
        ...
        <div>
          ...
          <ul class="text-slate-400 dark:text-gray-400 font-medium">
            <li class="mb-4">
              <a href="{{ $phone }}" class="hover:underline hover:text-white inline-flex gap-2">
            ...
            <li class="mb-4">
              <a href="{{ $whatsapp }}" class="hover:underline hover:text-white inline-flex gap-2">
            ...
            <li class="mb-4">
              <a href="{{ $facebook }}" class="hover:underline hover:text-white inline-flex gap-2">
                <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <li class="mb-4">
              <a href="{{ $instagram }}" class="hover:underline hover:text-white inline-flex gap-2">
                <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <li class="mb-4">
              <a href="{{ $youtube }}" class="hover:underline hover:text-white inline-flex gap-2">
                <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
      <span class="text-sm text-slate-500 sm:text-center ">© 2024 <a href="/" class="hover:underline">Desa Jelutung</a>. All Rights Reserved.
      </span>
    </div>
  </div>
</footer>
